 ...
 : RESET_STATUS STATUS @ 302 BIC 302 OR STATUS ! ;
 : RESET_FIFO CONTROL @ 10 BIC 10 OR CONTROL ! ;
 : SET_DATA_LENGTH DATA_LENGTH @ FFFF BIC 1 OR DATA_LENGTH ! ;
 : SET_SLAVE SLAVE_ADDRESS @ 7F BIC 27 OR SLAVE_ADDRESS ! ;
 : STORE_FIFO DATA_FIFO @ FF BIC OR DATA_FIFO ! ;
 : START_TRANSFER CONTROL @ 8081 BIC 8080 OR CONTROL ! ;
